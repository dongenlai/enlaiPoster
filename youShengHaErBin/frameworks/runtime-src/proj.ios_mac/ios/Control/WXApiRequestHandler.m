...
//By DongEnlai
+ (BOOL)sendImageData:(NSString *)imageName
           SceneTag:(NSString *)scenetag
              InScene:(enum WXScene)scene {
    
    WXImageObject *ext = [WXImageObject object];
    NSString* filePath = [NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@", imageName];

    WXMediaMessage *message = [WXMediaMessage message];
    [message setThumbImage:[UIImage imageNamed:filePath]];
...
+ (NSString *)payWithServiceData: (NSData *) data{

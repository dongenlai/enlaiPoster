...
#include "ngcc/ngccPubUtilsJsb.hpp"
#include "ngcc/ngccAudioJsb.hpp"
#include "ngcc/ngccWebSocketJsb.hpp"
#include "ngcc/ngccGameDownloadJsb.hpp"
...
int js_module_register()
{
	...
	// ngcc
	sc->addRegisterCallback(register_all_ngccPubUtilsJsb);
	sc->addRegisterCallback(register_all_ngccAudioJsb);
	sc->addRegisterCallback(register_all_ngccWebSocketJsb);
	sc->addRegisterCallback(register_all_ngccGameDownloaderJsb);
